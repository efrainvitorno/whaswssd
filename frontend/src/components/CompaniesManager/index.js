...
export default function CompaniesManager() {
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      ...
      await loadPlans();
      handleCancel();
      toast.success("Operacion realizada con Exitó!");
    } catch (e) {
      toast.error(
        "No se puede realizar la operación. Compruebe si ya existe una empresa con el mismo nombre o si los campos se han completado correctamentee"
      );
    }
    setLoading(false);
  };

...
const WhatsAppModal = ({ open, onClose, whatsAppId }) => {
  ...
  title={
    <Typography style={{ fontSize: "11px" }}>
      Tags disponiveis em alguns textos acima (cologar a tag
      entre colchetes duplos): <br></br> <br></br>
      <Grid
        container
        rowSpacing={1}
        columnSpacing={{
      ...
      >
        ...
        <Grid item xs={9}>
          &ensp;- Número do ticket. <br></br>&ensp;- Nome do
          setor. <br></br>
          &ensp;- Mensagem Saudação (Bom Dia, Boa Tarde e Boa Noite).
          <br></br>&ensp;- Nome do contato. <br></br>
          &ensp;- Número do protocolo. <br></br>&ensp;- Nome do usuário.
        </Grid>
      </Grid>
    </Typography>
  }

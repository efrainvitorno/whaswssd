...
const useStyles = makeStyles(theme => ({
	root: {
		width: "100vw",
		height: "100vh",
		background: "linear-gradient(to right, #F2E5A2 , #3FCAEA)", //Cor de fundo
...
const Login = () => {
	...
	return (
		...
		<Container component="main" maxWidth="xs">
			...
			<br/>
			<a target="_blank" href="https://whasapo.com" className={classes.powered}>CRM WHASAPO - https://whasapo.com/</a>
			<Box mt={8}>{/*<2023-Aventura Digital />*/}</Box>
		</Container>
		</div>
	);
};

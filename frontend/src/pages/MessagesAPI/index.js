  ...
  return (
    ...
    >
      <Typography variant="h5">
        Documentacion para envio de mensajes 
      </Typography>
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          ...
          <li>
            O El número de envío no debe tener máscara ni caracteres especiales y debe constar de:
              <ul>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{ \"number\": \"51925465788\", \"body\": \"Sua mensagem\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <ul>
              <li>
                <b>number: </b> 51925465788 
                <b>number: </b> 51943456743
              </li>
              <li>
                <b>medias: </b> archivo
              </li>
